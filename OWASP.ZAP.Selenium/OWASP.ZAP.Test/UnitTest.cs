...
namespace OWASP.ZAP.Test
{
    [TestClass]
    public class UnitTest
    {
        private static string _target = "https://online.asb.co.nz/apply/join/asb";
        private static string _apikey = "5ste6eglkhh83lvu263jqju2o3";
        private static ClientApi _api = new ClientApi("127.0.0.1", 8081, _apikey);
        private static IApiResponse _apiResponse;
        private static Process process;

        private void StartZapApp()
        {
